...
def test_expected_says_what_the_input_said(case):
    ...
    The goldens are formatted at the default style, which drops semicolons
    PSS does not require, so the verifier is told the same thing the CLI
    tells it -- see :func:`pssfmt.verify.check_token_equivalence`.
    """
